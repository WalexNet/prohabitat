                    ...
                    <div class="card-header"> <!-- Título de la Tabla y FORM Buscador -->
                        <div class="row">
                            ...
                            <div class="col-sm-6"> <!-- Formulario Busqueda --> 
                                <form role="form" action="<?= base_url('Aseguradora/buscar')?>" method="POST"> <!-- Formulario --> 
                                    <div class="input-group input-group-sm hidden-xs" >
                                        <input type="text" name="buscar_aseguradora" class="form-control" placeholder="Buscar por Propietario, Titular o Compañia">
