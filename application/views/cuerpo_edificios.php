        ...
        <div class="page-category"> <!-- Dentro de este DIV es donde ponemos los componentes o sea, nuestro cuerpo de accion -->
            <div class="container-fluid">
                ...
                <?php if ($ficha): ?> <!-- Si se pide ficha muestra ficha -->
                    <div class="row">
                        <div class="col-md-12"> <!-- Ancho de la Tarjeta -->
                            <div class="card card-post card-round"> <!-- Creamos la Tarjeta -->
                                <div class="card-header"> <!-- Header de la Tarjeta -->
                                    <label>DATOS DEL EDIFICIO</label>
                                </div>
                                <div class="card-body"> <!-- Body de la Tarjeta -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"> <!-- Dirección -->
                                            <label>Direcci&oacute;n</label>
                                            <p><?= $datos_ficha->direccion ?></p>
                                        </div>
                                        <div class="col-md-3"> <!-- Código Postal -->
                                            <label>C&oacute;digo Postal</label>
                                            <p><?= $datos_ficha->cp ?></p>
                                        </div>
                                        <div class="col-md-3"> <!-- Población -->
                                    ...
                                    <?php if ($datos_ficha->idpisos): ?> <!-- Si tiene pisos asociados los mostramos -->
                                        
                                        <div class="table-responsive"> <!-- Mostramos la tabla con pisos si los tuviera -->
                                    ...
                                    <?php else: ?> <!-- Si NO tiene pisos asociados mostramos mensaje de no los tiene -->
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" action="<?= base_url()?>Pisos/alta/TRUE" method="POST"> <!-- Formulario --> 
                                        <div class="row">
                ...
                <?php if (!$ficha && !$edita): ?> <!-- Si se pide ficha o edicion, no entra en Tabla -->
                    <div class="row"> <!-- Tabla -->
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header"> <!-- Título de la Tabla y FORM Buscador -->
                                    <div class="row"> <!-- Row Formulario-->
                                        ...
                                        <div class="col-md-6"> <!-- Formulario de busqueda -->
                                            <form role="form" action="<?= base_url()?>Edificios/buscar" method="POST"> <!-- Formulario --> 
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" action="<?= base_url()?>Edificios/alta" method="POST"> <!-- Formulario --> 
                                        <div class="row">
                ...
                <?php if ($edita):?>
                    <div class="card">
                        ...
                        <form role="form" action="<?= base_url()?>Edificios/modificar" method="POST"> <!-- Formulario --> 
