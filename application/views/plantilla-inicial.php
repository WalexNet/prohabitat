...
<body data-background-color="dark">
	...
	<!-- hasta aqui el header de la página -->
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="dark2">
				...
				<a href="index.html" class="logo">
					<img src="<?= base_url() ?>assets/img/walex.svg" alt="navbar brand" class="navbar-brand">
				</a>
			...
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="dark">
				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <!-- Icono Avatar al final del nav Arriba a la Derecha -->
                        <!-- 
						<li class="nav-item dropdown hidden-caret">
			...
			<!-- End Navbar -->
		</div> <!-- Fin de todo el encabezado el Navbar y logo Empresa -->
		...
		<div class="sidebar sidebar-style-2" data-background-color="dark2">
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<!-- Estos son los datos del login, en este caso el Administrador Hizrian	 -->
					<div class="user">
					...
					<ul class="nav nav-primary">
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="components/avatars.html">
											<span class="sub-item">Inquilinos</span>
										</a>
									</li>
						...
						<!-- aqui terminan las opciones del menú -->
					</ul>
		...
		<div class="main-panel">
			...
			<footer class="footer"> <!-- este es el pie de página propiamente dicho -->			
				<div class="container-fluid">
					<nav class="pull-left">
						<ul class="nav">
							<li class="nav-item">
								<a class="nav-link" href="https://www.walex.net">
									Walex.NET
								</a>
							</li>
							<li class="nav-item">
					...
					<div class="copyright ml-auto">
						2019, made with <i class="fa fa-heart heart text-danger"></i> by <a href="https://www.walex.net">Walex.NET</a>
					</div>				
				</div>
			</footer>
